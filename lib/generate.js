...
function createBabelOptions(opts) {
  ...
  if (utils.isNull(opts.modules) || opts.modules == 'commonjs') {
    opts.plugins.push(require.resolve('babel-plugin-add-module-exports'))
  }
  let babelOptions = {
    babelrc: true,
    cacheDirectory: true,
